...
export const newsSourcesConfig: CountryNewsConfig[] = [
  {
    ...
    sources: [
      ...
      { name: "Khaama Press", url: "https://www.khaama.com" },
      { name: "Bakhtar News Agency", url: "https://bakhtarnews.af/" },
      { name: "RTA (YouTube)", url: "https://www.youtube.com/@rtapashto" },
      { name: "Ariana News (YouTube)", url: "https://www.youtube.com/@ariananewsaf" },
      { name: "TOLOnews (YouTube)", url: "https://www.youtube.com/@Tolonews" }
    ]
  },
  {
    countryName: "Albania",
  ...
  },
  {
    ...
    sources: [
      ...
      { name: "Journal du Tchad", url: "https://journaldutchad.com" }
    ]
  },
  {
    countryName: "Chile",
  ...
  },
  {
    ...
    sources: [
      ...
      { name: "ADDS", url: "https://addis.djibouti" }
    ]
  },
  {
  ...
  },
  {
    ...
    sources: [
      ...
      { name: "The UB Post", url: "https://theubpost.com" }
    ]
  },
  {
